...
urlpatterns = [
    ...
    path('sales/delivery-notes/<int:pk>/delete/', views.DeliveryNoteDeleteView.as_view(), name='delivery_note_delete'),
    ...
    path('sales/returns/<int:return_pk>/credit-note/create/', views.credit_note_create_view, name='credit_note_create'),
    ...
    path('sales/credit-notes/<int:pk>/approve/', views.credit_note_approve_view, name='credit_note_approve'),
    path('sales/credit-notes/<int:pk>/reject/', views.credit_note_reject_view, name='credit_note_reject'),
